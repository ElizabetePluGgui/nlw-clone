  ...
  return (
    <div className="App">
      ...
      <div class="hero-information">
        ...
        <br></br>
        <p class="hero-nome">Matheus Henrique</p>
      ...
      {/* <div className="about">
        ...
        <div className="about-content">
          <h1>
            O que é a Next<br></br>Level Week?
          </h1>
          <p className="highlight">
            O NLW é um evento com muito código, desafios, networking e um único
            objetivo: te levar para o próximo nível.
          </p>
          <p>
            Acreditamos que programação é uma disciplina prática. Ou seja, para
            dominar uma tecnologia não basta apenas conhecer a teoria ou ler a
            documentação: você precisa colocar a mão no código.
          </p>
          <p>
            Através do nosso método você vai aprender novas ferramentas,
            conhecer novas tecnologias e descobrir hacks que vão impulsionar a
            sua carreira.
          </p>
          <p>
            Uma experiência online e totalmente gratuita para evoluir suas
            habilidades em programção e colocar mais um trabalho no seu
            portfólio.
          </p>
        </div>
      </div> */}
